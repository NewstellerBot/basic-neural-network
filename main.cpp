...
public:
    ...
    double getRecentAvaregeError(void) {return m_recentAverageError;}
...
int main()  {
    TrainingData TrainingData("./samples.txt");
    ...
    while(!TrainingData.isEof())    {
        ...
        << setprecision(5) << myNet.getRecentAvaregeError() << endl;
    }
